...
<tr>
  <td class="px-6 py-4 whitespace-nowrap text-sm"> Pose Auto-Calibration </td>
  <td class="px-6 py-4 text-sm">
    <div class="mb-3">
      ...
      <div class="m-3" />
      <Text
        label="Timer (Delay time)"
        bind:value={$state.form.calibrationTimer}
      />
    </div>
    <b>Automatically calibrate your controller offsets:</b>
    <br />
    Clicking the button will start a 10 second timer and will freeze your in-game
    hand. During the delay, move your hand to the position of the hand in-game. Once
    the timer is up, you should see your virtual hand move with your real hand.
  </td>
  <td class="px-6 py-4 whitespace-nowrap text-sm flex flex-row">
    <SuspenseButton
      onClick={async () => beginCalibration()}
