 ...
 */
const getValuesForConfiguration = async (configObj) =>
  makeHTTPRequest("settings/get", "POST", configObj);
export const saveConfiguration = async (configObj) =>
  makeHTTPRequest("settings/set", "POST", configObj);
...
export const createConfiguration = (configurationOptions) => {
  ...
  result[primaryConfigurationSection] =
    temp[primaryConfigurationSection].options;
